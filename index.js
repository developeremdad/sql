...
const fileName = process.argv[2] + ".sql"; // e.g., "basic.sql"
...
`);
  ...
  // Build the full path to the query file
  const filePath = path.join(process.cwd(), "query", fileName);
  ...
  console.clear();
  console.log(`📄 Results from ${fileName}:`);
